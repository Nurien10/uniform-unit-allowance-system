<%-- 
    Document   : register_externalofficer
    Created on : 15 Jan 2025, 3:54:42 pm
    Author     : HP
--%>
    ...
    <script>
        function validateForm() {
            ...
            if (!icPattern.test(icInput.value)) {
                icError.textContent = "IC format is invalid.";
                isValid = false;
            }
...
<body>
    ...
    <div id="content">
    <h1>Register (External Officer)</h1>
    ...
    <form action="register" method="post" onsubmit="return validateForm()">
        ...
        <a href="external_officer.jsp" class="back-button">Back</a>
    </div>
        </form
