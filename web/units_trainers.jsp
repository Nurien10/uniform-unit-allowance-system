<%-- 
    Document   : units_trainer
    Created on : 15 Jan 2025, 3:30:10 pm
    Author     : HP
--%>
<html>
<head>
    <title>Units Trainer Login</title>
   <style>
      body {
...
<body>
    ...
    <div id="content">
        <h1>Login (Units Trainers)</h1> <!-- Centered above the form -->
        <form action="login" method="post">
            ...
            <div class="signup-link">
                ...
                <a href="registerunits_trainers.jsp">Sign Up</a>
            </div>
        </form>
