<%-- 
    Document   : allowanceunits_highcouncil
    Created on : 1 Jul 2025, 9:23:16 pm
    Author     : HP
--%>
...
<html>
<head>
    <title>Allowance Units Members (Units High Council)</title>
    <style>
        body {
...
<div id="content">
    ...
    <h1>Allowance Units Members (Units High Council)</h1>

    <!-- Filter Form -->
    <div style="display: flex; justify-content: center; margin-bottom: 20px;">
        <form method="get" action="allowanceunits_highcouncil.jsp" style="display: flex; gap: 10px; align-items: center;">
