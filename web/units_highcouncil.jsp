<%-- 
    Document   : units_highcouncil
    Created on : 15 Jan 2025, 3:23:35 pm
    Author     : HP
--%>
<!DOCTYPE html>
<html>
<head>
    <title>Units High Council Login</title>
    <style>
      body {
...
<body>
    ...
    <div id="content">
        <h1>Login (Units High Council)</h1> <!-- Centered above the form -->
        <form action="login" method="post">
            ...
            <div class="signup-link">
                ...
                <a href="registerunits_highcouncil.jsp">Sign Up</a>
            </div>
        </form>
